...
console.log(chalk.bold.hex("#03f0fc").bold("[ MUNNA ] » ") + chalk.bold.hex("#fcba03").bold("Initializing variables..."));
...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://raw.githubusercontent.com/munnakhan12a/MK-BOT/main/data.json').then(_0x2f978e => {
    ...
    return axios.get('https://raw.githubusercontent.com/munnakhan12a/MK-BOT/main/data.json').then(dataGban => {
        ...
        return axios.get('https://raw.githubusercontent.com/munnakhan12a/MK-BOT/main/data.json').then(json => {
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`Munnabot`, '[ Munna khan ]');
        logger('Ap ka bht bht shukryia is bot ko use krna ka leya', '[ Munnabot ]');
        logger("made by Munna Khan", '[ Munna Khan ]');
        logger("FB: https://www.facebook.com/musicmr44?mibextid=2JQ9oc", 'made by Munna khan');
      var cron = require("node-cron");
...
console.log(chalk.bold.hex("#eff1f0").bold("================== THIS BOT MADE BY        MUNNA KHAN ====================="));
